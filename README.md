# Angular Boot Camp example: legacy-ng-modules-routing
...
**[StackBlitz for legacy-ng-modules-routing](https://stackblitz.io/github/AngularBootCamp/legacy-ng-modules-routing)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/legacy-ng-modules-routing.git
cd legacy-ng-modules-routing
npm install
npm start
```
